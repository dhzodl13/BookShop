		...
		<c:otherwise>
			<c:forEach var="pdList" items="${pdList }">
				<div id="table_content">
					...
					<div class="table_content"><img src="resources/upload/${pdList.pd_file }" width="60" height="75"></div>
					...
					<div class="table_content">
						<input type="button" value="상품선택" onclick="selectProduct(${pdList.pd_num })">
					</div>
				</div>
			</c:forEach>
		</c:otherwise>
...
<input type="hidden" name="quan" value="${pd_quan }">
<input type="hidden" name="type" value="${pd_type }">
