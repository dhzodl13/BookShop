    	...
    	<c:choose>
    		...
    		<c:choose>
    			<c:when test="${not empty qnaList }">
    				<div class="private_subject">${sessionScope.sName }님의 문의입니다</div>
	    		...
	    		<c:otherwise>
	    			<div class="private_subject">${sessionScope.sName }님의 문의</div>
	    				<div class="public_content_flex"></div>
	    					<div class="none">${sessionScope.sName }님의 문의가 없습니다.</div>
