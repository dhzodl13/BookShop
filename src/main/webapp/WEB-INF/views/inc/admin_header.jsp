...
<header>
	...
	<div class="top">
		<div class="header_cell">
			<!-- 로고 들어갈 자리 -->
			<a href="AdminPage.ad">
				<img alt="로고" src="resources/images/BookShopLogo2.png" height="60px" width="200px">
			</a>
			<!-- 로고 들어갈 자리 -->
	...
	<div id="mySidenav" class="sidenav">
		...
		<div>
			<a href="OrderList.ad?order_status=all">주문내역</a>
			<a href="ProductList.ad?type=all&quan=all">상품관리</a>
			<a href="QnaList.ad">고객문의</a>
			<a href="UserManagement.ad">회원정보</a>
