...
<link href="resources/css/admin_order_list.css" rel="stylesheet"/>
...
<script type='text/javascript'>
	...
	$(function() {
		...
		var orderYes_form = $(".orderYes_form").serialize();
			$.ajax({
				type:"get",
				url:"OrderGetList.ad",
				data:orderYes_form,
		...
		<div id="search_div">
			<div class="product_search">
				...
				<div class="cell">
					...
					<input type="radio" name="order_status" value="판매완료" class="status_select">판매완료&nbsp;&nbsp;
				</div>
