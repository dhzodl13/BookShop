...
<meta charset="UTF-8">
<title>상품게시판</title>
<link href="resources/css/admin_product_write.css" rel="stylesheet">
</head>
<body>
	<!-- 헤더부분 -->
	...
	<form action="ProductWritePro.ad?type=all&quan=all" method="post" enctype="multipart/form-data"> 
		<table class="myTable">
			<tr>
