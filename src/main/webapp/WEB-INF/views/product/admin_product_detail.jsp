...
<link href="resources/css/admin_product_detail.css" rel="stylesheet" />
...
<body>
	...
	<div class="wrapper">
		<div class="product_info">
			<img src="resources/upload/${product.pd_file }" align="left">
		...
		<section id="sidebar_section">
			<div class="sidebar">
				<input type="button" value="상품목록" onclick="location.href='ProductList.ad?type=all&quan=all'">
				<input type="button" value="상품수정" onclick="location.href='ProductUpdate.ad?pd_num=${param.pd_num}'">
