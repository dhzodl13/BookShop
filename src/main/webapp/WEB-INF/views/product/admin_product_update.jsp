...
<link href="resources/css/admin_product_update.css" rel="stylesheet">
</head>
<body>
	<!-- 헤더부분 -->
	...
	<form action="ProductUpdatePro.ad?pd_num=${param.pd_num }" method="post" enctype="multipart/form-data"> 
		<table class="myTable">
			<tr>
