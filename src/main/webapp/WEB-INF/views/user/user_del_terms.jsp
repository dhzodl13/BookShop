...
<link href="resources/css/user_terms.css" rel="stylesheet" type="text/css">
...
<body>
	<div class="terms_header">
		<a href="./" class=book_logo1><img alt="로고" src="resources/images/BookShopLogo2.png" width="400px"></a>
	</div>
	<section class="terms">
	<form class="form_area" action="MyInfoDelPro.us?sId=${param.sId }" onsubmit="return checkTerms()" method="get" name="fr">
		<!-- 전체 동의 -->
		
		<section class="agree">
			<span id="checkAll">
				<b>
					*주의! 북샵 탈퇴 시 기존 보유 포인트와 적립금은 소멸되며, 진행중인 주문과 문의내역이 있으시면 사용에 불편함을 겪을 수 있습니다.
...
11.전기통신기본법, 전기통신사업법, 정보통신 윤리강령, 정보통신 윤리위원회 심의규정, 프로그램 보호법 및 기타관련 법령과 약관이 금지하는 행위를 한 경우</div>
		...
		<section class="agree">
			...
			<div class="text_area"> 1. 회원 탈퇴 시 사용했던 아이디(이메일)은 60일간 사용이 불가합니다.<br>
			2. 기 보유중 포인트 및 적립금은 소멸되며, 주문 및 문의 등 관련된 모든정보는 6개월 간 보호 후 파기됩니다.<br>
			3. 2번에 해당하는 연락은 따로 드리지 않습니다.<br>
			4. 탈퇴 시 취소는 불가하며 관련 문의는 고객센터로 유선 연락 바랍니다.<br>
			5. 지금까지 본 사이트를 이용해주셔서 감사합니다. 모든 약관 및 주요 확인 사항에 동의하신다면 동의 버튼을 눌러주시고 탈퇴를 진행해주세요.<br>
			6. 더 나은 서비스로 고객님을 다시 만날 수 있길 고대합니다.<br>
				
</div>
		</section>
		<input type="submit" value="탈퇴 확정" class="submit">
	</form>
 	</section>
 	<!-- 푸터 -->
	<%-- <jsp:include page="w/inc/footer.jsp"/> --%>
	<!-- 푸터 -->
</body>
</html>