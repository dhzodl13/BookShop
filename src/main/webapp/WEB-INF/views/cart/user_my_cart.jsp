...
<link href="resources/css/user_my_cart.css" rel="stylesheet">
...
<body>
	...
	<div class="cart">
	<img alt="카트" src="resources/images/cart.png" >
	<h1 align="center"></h1>
	<hr>
				...
				<table class="jur"width="100%">
					...
					<c:forEach var="list" items="${cartList }">
						<tr class="text">
							...
							<td>
							 <div class="delete">
							  <input type="button" name="delete" value="삭제" onclick="location.href='MyCartDel.us?sId=<%=sId %>&pd_num=${list.pd_num }'">
							 </div>
							</td>
